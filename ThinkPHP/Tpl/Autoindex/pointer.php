        ...
        foreach ($info as $key => &$val)
        {
            ...
            if (is_numeric($val[1]) || $val['value']==$val[1])
            {
               $val['message'] = '<span class="blue">√</span>';
                ...
                $val['message'] = '<span class="green">'.$val[2].'</span>';
            }
        }
...
HTML;
        $moban .="<tr><th class='tbhead'>是否开启rewrite</th><td>";
            ...
            $moban .= '<a href="http://sae.sina.com.cn/?m=devcenter&catId=34#anchor_4bc6c66b7146416bbb4e492d30b0e02e">SAE rewrite 文档</a>';
            $moban .="</td><td></td></tr>";
